...
function c312823.spfilter(c,e,tp)
...
function c312823.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tc=Duel.GetFirstTarget()
	if tc:IsRelateToEffect(e) and Duel.SpecialSummonStep(c312823.spfilter,0,tp,tp,false,false,POS_FACEUP_DEFENSE) then
